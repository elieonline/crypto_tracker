...
mixin ValidatorsMixin {
  ...
  final _phoneNoReg = RegExp("^(09|07|08)\\d{9}\$");
  ...
  @protected
  bool isAmount(String str) {
    return _amount.hasMatch(str);
  }

  @protected
  bool isGreaterThan(String str, double value) {
    return double.parse(str) >= value;
  }

  @protected
  bool isLessThan(String str, double value) {
    return double.parse(str) <= value;
  }
  ...
  bool isNameValid(String? text) {
    return !isEmpty(text) && !text!.contains(" ");
  }
  ...
  @protected
  bool hasSameValue(dynamic value1, dynamic value2) {
